        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div whileHover={{ y: -8 }}>
              <Card className="border-none shadow-lg hover:shadow-2xl transition-all bg-gradient-to-br from-white to-red-50/30 overflow-hidden group relative h-full">
            ...
            <motion.div whileHover={{ y: -8 }}>
              <Card className="border-none shadow-lg hover:shadow-2xl transition-all bg-gradient-to-br from-white to-amber-50/30 overflow-hidden group relative h-full">
            ...
            <motion.div whileHover={{ y: -8 }}>
              <Card className="border-none shadow-lg hover:shadow-2xl transition-all bg-gradient-to-br from-white to-green-50/30 overflow-hidden group relative h-full">
            ...
            <motion.div whileHover={{ y: -8 }}>
              <Card className="border-none shadow-lg hover:shadow-2xl transition-all bg-gradient-to-br from-white to-purple-50/30 overflow-hidden group relative h-full">
